...
0. Preliminary info & course motivation
...
### Why learn programming in the age of generative AI?

* Generative AI can write a lot of code — and this makes programming skills **more useful, not less**
    * much lower cost of turning an idea into a working program
    * programmers can build more ambitious things, faster

* But you need to know **what to ask for**
    * decompose a problem into manageable tasks
    * formulate precise requirements
    * understand what tools, data structures and algorithms are appropriate

* You need to know **whether the generated code is correct**
    * AI-generated code can look convincing while being subtly wrong
    * read and understand code
    * test, debug and validate results

* Real programming is more than generating individual pieces of code
    * connect components into a working system
    * understand data flow, dependencies and interfaces
    * maintain and modify existing code

* Programming knowledge lets you use AI effectively
    * AI can take care of much of the syntax and boilerplate
    * you can concentrate more on the problem, design and logic
    * knowing programming makes you much better at directing and evaluating AI

* The goal is therefore not necessarily to become faster than AI at **writing code**
    * it is to become good at **solving problems with code and AI**
...
* To take advantage of massive amounts of data flowing around. It is a good idea to know:
    * how to get it
    * how to store It
    * how to process it
    * how to analyze it
...
3. **Data** - *Work on your project.* The last block would be helping to get a hands-on experience and to apply the skills gained throughout the course.
...
* The task is to 
    ...
    5. Build an interactive app presenting your project (e.g. Streamlit)
